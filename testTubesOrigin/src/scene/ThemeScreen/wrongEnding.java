...
public class wrongEnding extends javax.swing.JFrame {

    private posisi posisiBoxText;
    private int counterTeks;
    private String teks;
    private posisi posisiButtonNext;
    private String namaTertuduh;
            
    public wrongEnding() {
        this.setUndecorated(true);
        
        initComponents();
        setExtendedState(wrongEnding.MAXIMIZED_BOTH);
    ...
    private void opsiTeks(int counter) {
        ...
        switch (counter) {
            case 1 :
                teks = """
                         ========== NORMAL ENDING: SETENGAH KEBENARAN ==========""";
                break;
            case 2 :
                teks = "Kamu menjatuhkan tuduhan berat pada "
             + namaTertuduh + ".\n"
             + "Ruang sidang gempar karena bukti yang kamu bawa "
             + "terkesan dipaksakan.";
                break;
            case 3 :
                teks = """
                       Orang yang tidak bersalah dijebloskan ke penjara,
                       sementara sang pembunuh asli menertawakan
                       kebodohanmu dari kegelapan.""";
                break;
    ...
    private void initComponents() {
        ...
        boxText.setBounds(173, 145, 629, 230);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wrongEnding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wrongEnding().setVisible(true);
            }
        });
    }
