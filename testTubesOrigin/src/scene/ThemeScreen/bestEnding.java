...
public class bestEnding extends javax.swing.JFrame {
    ...
    public bestEnding() {
        ...
        initComponents();
        setExtendedState(bestEnding.MAXIMIZED_BOTH);
    ...
    private void opsiTeks(int counter) {
        ...
        switch (counter) {
            case 1 :
                teks = """
                        ========== BEST ENDING: KEBENARAN SEJATI ==========
                       
                                  "Tuan Vesper... Kamulah dalang di balik semua ini!""";
                break;
            case 2 :
                teks = """
                       Keheningan mencekam memenuhi ruang sidang sebelum
                                  akhirnya Vesper mengaku karena semua bukti mutlak
                                  mengunci pergerakannya.""";
                break;
            case 3 :
                teks = """
                       Vesper berhasil ditangkap dan dieksekusi.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bestEnding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bestEnding().setVisible(true);
            }
        });
    }
