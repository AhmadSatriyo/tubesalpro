...
public class normalEnding extends javax.swing.JFrame {
    ...
    public normalEnding() {
        ...
        initComponents();
        setExtendedState(normalEnding.MAXIMIZED_BOTH);
    ...
    private void opsiTeks(int counter) {
        ...
        switch (counter) {
            case 1 :
                ...
                break;
            case 2 :
                teks = "Kamu berhasil menangkap " + namaTertuduh
                 + " sebagai pelaku lapangan.\n"
                 + "Keadilan berhasil ditegakkan di mata publik.";
                break;
            case 3 :
                teks = """
                       Namun di balik bayangan, sang dalang asli
                       tersenyum puas karena posisinya sama sekali tidak
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(normalEnding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new normalEnding().setVisible(true);
            }
        });
    }
