...
public class badEnding extends javax.swing.JFrame {
    ...
    public badEnding() {
        ...
        initComponents();
        setExtendedState(badEnding.MAXIMIZED_BOTH);
    ...
    private void opsiTeks(int counter) {
        ...
        switch (counter) {
            ...
            case 4 :
                teks = """
                       Pembunuh raja yang asli tidak pernah ditemukan, 
                       dan Kerajaan Valdris jatuh ke tangan tirani yang salah.
                       """;
                break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(badEnding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
