...
public class briefingScrene2 extends javax.swing.JFrame {
    ...
    public briefingScrene2() {
        this.setUndecorated(true);
        
        initComponents();
        setExtendedState(briefingScrene2.MAXIMIZED_BOTH);
        ...
        switch (counter) {
            case 1 :
                teks = """
                       ...
                       Kunjungi berbagai lokasi di dalam kastil.
                       
                       Temukan petunjuk.
                       
                       Interogasi para tersangka.
                       
                       Pisahkan kebohongan dari kebenaran.""";
                break;
            case 2 :
                teks = """
                       INFORMASI PENTING
                       
                       Tidak semua orang mengatakan kebenaran.
                       
                       Setiap tersangka memiliki sifat kejujuran yang berbeda:
                       
                       Selalu Jujur — seluruh pernyataannya benar.
                       
                       Selalu Bohong — seluruh pernyataannya salah.
                       
                       Kadang Jujur — pernyataannya bisa benar atau salah.""";
                break;
            case 3 :
                teks = """
                       Catat setiap petunjuk yang kamu temukan.
                       
                       Karena ketika hari penobatan tiba...
                       
                       Kamu hanya memiliki satu kesempatan untuk menentukan siapa pembunuh sebenarnya.""";
                break;
            case 4 :
                teks = """
                       Hari 1
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(briefingScrene2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new briefingScrene2().setVisible(true);
            }
        });
    }
