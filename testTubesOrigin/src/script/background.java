...
//
//    /**
//     * Method untuk mengambil gambar dari folder assets dan otomatis me-resize
//     * sesuai ukuran JLabel tujuan.
//     * * @param pathGambar Nama file gambar (misal: "/assets/tangga.jpg")
//     * @param labelTujuan JLabel yang ingin ditempeli gambar
//     * @return ImageIcon yang sudah pas ukurannya
//     */
//    
//    private String path;
//    private String nama;
...
//    }
//    
//    public static ImageIcon ambilGambar(String pathGambar, JLabel labelTujuan) {
//        
//        try {
//         
//            URL imgURL = background.class.getResource(pathGambar);
//            
//            if (imgURL != null) {
//                ImageIcon iconMentah = new ImageIcon(imgURL);
//                
//                // 2. Ambil ukuran lebar dan tinggi dari JLabel tujuan
//                int lebar = labelTujuan.getWidth();
//                int tinggi = labelTujuan.getHeight();
//                
//                // Jika JLabel belum dirender (lebar/tinggi masih 0), beri ukuran default agar tidak error
//                if (lebar <= 0) lebar = 800; 
//                if (tinggi <= 0) tinggi = 600;
//                
//                // 3. Proses resize gambar biar pas
//                Image imgResize = iconMentah.getImage().getScaledInstance(lebar, tinggi, Image.SCALE_SMOOTH);
//                
//                // 4. Kembalikan hasilnya dalam bentuk ImageIcon baru
//                return new ImageIcon(imgResize);
//            } else {
//                System.err.println("Aset tidak ditemukan pada path: " + pathGambar);
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
